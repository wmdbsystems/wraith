...
function snap() {
  ...
  // Inject deactivated for testing
  casper.waitForSelector('body', function then() {
    ...
    casper.echo('[Timeout] ' + url, 'WARNING');
  });
...
function captureImage() {
  ...
  casper.waitFor(function() {
    return this.evaluate(function() {
      ...
      /*
       * Very Bad Hack by Janek.Ruessmann
       * Schaltet die Überprüfung und das Warten auf alle Bilder ab, aber es gibt keinen Timeout mehr und Wraith läuft durch
       */
